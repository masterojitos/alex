...
--
-- Servidor: localhost
-- Tiempo de generación: 03-05-2011 a las 06:54:53
...
(1, 1, 'diego0', 'VOTO VICIADO: SI CONTAMOS LOS VOTOS D LAS ULTIMAS ELECCIONES SON LOS 2/3 D VOTOS Y ANULAMOS LAS ELECCIONES. PASA LA VOZ!', 1303763868, '1'),
(2, 1, 'aldo2011', 'antes de referisrte al sr. MVLL, debes presentar tu plan de gobierno de explicarlo, mostralo. no tienes nivel gorda corrupta.', 1303764868, '1'),
(3, 2, 'yeritall', 'por eso no uso el twiTter ........... solo facebook xD ', 1303795896, '0'),
(4, 2, 'lalokis', 'igualmente cerrando el twitter t me quedo con el face nomas =)', 1303797496, '1'),
(5, 1, 'lobo13', 'Una nueva era se acerca, gocen sus ultimas semanas de pecado, ya que despues sentiran el verdadero dolor de la abstinencia. ', 1303773996, '0'),
(6, 3, 'angeluz', 'como le cuelga el cuello xD ', 1303766868, '0');
